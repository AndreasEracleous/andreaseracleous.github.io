...
var scrollme=document.getElementById("scrollme");function runScroll(){scrollTo(document.documentElement,0,300)}function scrollTo(o,e,n){if(!(n<0)){var t=(e-o.scrollTop)/n*10;setTimeout(function(){o.scrollTop=o.scrollTop+t,scrollTo(o,e,n-10)},10)}}null!=scrollme&&scrollme.addEventListener("click",runScroll,!1);var AsyncImage=function(o){this.preLoadImage=new Image,this.preLoadImage.currentImg=o,this.preLoadImage.onload=function(){this.currentImg.src=this.src,this.currentImg.removeAttribute("data-src")},this.preLoadImage.onerror=function(){throw new Error("Could not load the big image.")}};AsyncImage.prototype.startDownloading=function(){var o=this.preLoadImage.currentImg.dataset.src;this.preLoadImage.src=o};for(var imgLength=document.images.length,i=0;i<imgLength;i++)new AsyncImage(document.images[i]).startDownloading();var font1=new FontFaceObserver("Nunito Sans");if(font1.load().then(function(){console.log("Nunito Sans is available"),sessionStorage.fontsLoaded=!0}).catch(function(){sessionStorage.fontsLoaded=!1}),sessionStorage.fontsLoaded){var html=document.documentElement;html.classList.add("fonts-loaded")}var font2=new FontFaceObserver("Geomanist");font2.load().then(function(){console.log("Geomanist is available"),document.documentElement.className+=" fonts-loaded"});